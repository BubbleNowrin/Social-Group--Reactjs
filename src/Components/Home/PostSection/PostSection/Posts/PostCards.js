        ...
        <div className='container mt-4'>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-outline-secondary w-100 mt-1 mb-4"><span className='text-danger fw-bold'>Visit Website</span></button>
                    <div className='d-flex justify-content-between align-items-center'>
                        <div className='d-flex align-items-center '>
                            <img src={writer2} alt="" />
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-outline-secondary w-100 mt-1 mb-4"><span className='fw-bold text-success'>Apply on Timesjobs</span></button>
                    <div className='d-flex justify-content-between align-items-center'>
                        <div className='d-flex align-items-center '>
                            <img src={writer3} alt="" />
